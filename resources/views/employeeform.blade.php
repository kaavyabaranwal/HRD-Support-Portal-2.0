                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="registration-form-body">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <form name="personal" action="" method="POST" class="tab-pane fade show active"
                                id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            <label>First Name</label>
                                            <input type="text" value="" id="" name="firstname"
                                    ...
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" id="" name="lastname"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" id="" name="emp_code"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" id="" name="designation"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" id="" name="department"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" id="" name="organisation"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" id="" name="phone"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" id="" name="address"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" id="" name="district"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            <label>Pincode</label>
                                            <input type="tel" value="" id="" name="pincode"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            <label>E-mail</label>
                                            <input type="email" value="" id="" name="email"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            <label>FAX</label>
                                            <input type="number" value="" id="" name="fax"
                                                class="form-control icon-inside" />
                                        </div>
                                    </div>
